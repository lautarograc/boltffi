...
pub struct WireFunctionTemplate<'a> {
    ...
    pub err_type: &'a str,
    pub ffi_name: &'a str,
    pub return_abi: &'a super::plan::KotlinOutputRoute,
...
mod tests {
    ...
    use super::super::plan::{
        ...
        KotlinEnumField, KotlinEnumVariant, KotlinMethod, KotlinMethodImpl, KotlinOutputRoute,
    ...
    fn snapshot_sync_function_returning_primitive() {
        let template = WireFunctionTemplate {
            ...
            return_abi: &KotlinOutputRoute::Direct {
    ...
    fn snapshot_sync_function_with_string_param() {
        let template = WireFunctionTemplate {
            ...
            return_abi: &KotlinOutputRoute::WireEncoded,

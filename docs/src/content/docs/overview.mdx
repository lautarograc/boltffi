...
The generated bindings use native idioms. Swift gets `async`/`await` and throwing functions. Kotlin gets coroutines and sealed classes. Your Rust library feels like a native SDK.
